    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            if(jsonCookie!=null)
            {
                ...
                {
                    Product product=_context.Products.Where(p => p.IsPrime == false).Include(p=>p.ProductImages.Where(p=>p.IsPrime==true)).FirstOrDefault(p=>p.Id==item.Id);
                    if(product==null)
                    {
        ...
        public IActionResult AddBasket(int id)
        {
            ...
            Product product=_context.Products.Where(p => p.IsPrime == false).FirstOrDefault(p => p.Id == id);
